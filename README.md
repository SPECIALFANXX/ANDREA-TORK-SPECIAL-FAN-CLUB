...
<div id="paymentConfirmation" class="page">
    ...
    <p>Please forward all payment screenshots to the following email address: andreatork120@gmail.com</p>
...
<script>
    ...
    paymentForm.addEventListener('submit', function(event) {
        ...
        switch (selectedPaymentMethod) {
            case 'CashApp':
                paymentInfo = 'Cash App: $Jimfitz63';
                break;
            case 'Crypto':
                paymentInfo = 'Crypto: 39akBbL6wcf2fcnzxDNjUUwfb5XmvDEqKK';
                break;
        }
